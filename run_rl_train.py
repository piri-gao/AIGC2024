from agent.MAPPO_AIGC.MAPPO_AIGC_main_mp import Runner_MAPPO_AIGC
...
if __name__ == '__main__':
    ...
    # device = 'cpu'
    if algorithm == "QMIX" or algorithm == "VDN":
        ...
        parser.add_argument("--train", type=bool, default=True, help="Test or Train")
        parser.add_argument("--algorithm", type=str, default="QMIX", help="QMIX or VDN")
        parser.add_argument("--num_workers", type=int, default=8, help="number of workers")
        parser.add_argument("--max_train_steps", type=int, default=int(1e9), help=" Maximum number of training steps")
        parser.add_argument("--evaluate_freq", type=float, default=50000, help="Evaluate the policy every 'evaluate_freq' steps")
        ...
        parser.add_argument("--use_bl", type=bool, default=False, help="Whether to use BL")
        ...
        parser.add_argument("--use_reward_scaling", type=bool, default=True, help="Trick 4:reward scaling. Here, we do not use it.")
        ...
        if args.train:
            ...
            runner.evaluate_policy(train=False)
        ...
        parser.add_argument("--use_agent_specific", type=bool, default=False, help="Whether to use agent specific global state.")
        parser.add_argument("--use_value_clip", type=bool, default=True, help="Whether to use value clip.")
