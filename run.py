...
class BattleRunnerSignal(EnvRunner):
    ...
    def run(self, num_episodes, map_start = "N"):
        ...
        for i in range(num_episodes):
            ...
            print("共", i + 1, "局：   红方胜", battle_results[0], "局：   蓝方胜", battle_results[1], "局：   平局",battle_results[2], "局：   胜率", battle_results[0]/(i+1),"   红方分数", done[1],"   蓝方分数", done[2],)
