    ...
    def step(self, cmd_list: List[dict]):
        ...
        for cmd in cmd_list:
            for k, control in cmd.items():
                ...
                elif k == "CmdJamControl":
                    cmd_jam_control.append(pb2.CmdJam(
                        HandleID=control.get("HandleID"),
                        Receiver=control.get("Receiver"),
                    ))
        ...
        step_response = self.client.Step(pb2.CmdRequest(
            ...
            CmdJamControl = cmd_jam_control,
        ),timeout=2)
        # logging.info(step_response)
