...
class QMIX_AIGC(object):
    ...
    def save_model(self, env_name, algorithm, number, seed, total_steps):
        torch.save(self.eval_Q_net.state_dict(), "agent/QMIX_VDN_AIGC/model/{}_{}_eval_rnn_number_{}_seed_{}_step_{}k.pth".format(env_name, algorithm, number, seed, int(total_steps / 1000)))

    def load_model(self, env_name, algorithm, number, seed, total_steps):
        self.eval_Q_net.load_state_dict(torch.load("agent/QMIX_VDN_AIGC/model/{}_{}_eval_rnn_number_{}_seed_{}_step_{}k.pth".format(env_name, algorithm, number, seed, int(total_steps / 1000))))
