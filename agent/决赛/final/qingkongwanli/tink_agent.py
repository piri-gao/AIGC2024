...
from agent.qingkongwanli.agent_info import Plane, Missile
...
class DemoAgent(Agent):
    ...
    def update_decision(self, obs_side, cmd_list):
        ...
        if self.sim_time <= 2:
            ...
            for leader in self.my_leader_plane:
                ...
                if leader.ID in self.free_plane:
                    if total_dir != {"X": 0, "Y": 0, "Z": 0} and leader.do_jam==False:
                        ...
                        elif min_dis<8000 or leader.be_seen==False:
                            if self.sim_time%2:
                                total_pitch = -math.pi/6
                            else:
                                total_pitch = math.pi/6
            ...
            # 给己方被威胁飞机安排跟踪飞机
            for plane in self.my_plane:
                if plane.be_in_danger and plane.follow_plane==None and plane.Availability and plane.wing_plane==None:
