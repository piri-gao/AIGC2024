...
from agent.QYKZ_final.agent_base.agent_base_v7 import Plane, Missile

class Agent_v7(Agent):

    def __init__(self, name, config):
        super(Agent_v7, self).__init__(name, config['side'])
        self._init()
    ...
    def UAV_away(self, no_missile_plane, cmd_list):
        for plane in self.my_plane:
    ...
    def synthetic_threat_vector(self, leader, see_dis=35000, seen=True):
    ...
    def update_decision(self, obs_side, cmd_list):
        ...
        if self.sim_time <= 2:
            ...
            # 无人机脱离
            self.UAV_away(no_missile_plane, cmd_list)
            # 分配僚机
