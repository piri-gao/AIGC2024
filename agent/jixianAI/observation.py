...
from agent.jixianAI.agent_base import MyJet, EnemyJet, Missile
        ...
        for obs_agent_info in obs_list:
            ...
            for agent_info in self.agent_info_list:
                if obs_agent_info['ID'] == agent_info.ID:
                    ...
                    self.agent_info_dic[obs_agent_info["Name"]] = agent_info
                    agent_in_list = True
                    break
...
class MissileObservation(object):
    ...
    def get_enemy_missile_list(self, Identification):
        enemy_missile_list = []
        for missile in self.missile_info_list:
            if missile.Identification != Identification:
