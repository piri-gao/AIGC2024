...
from agent.tink_AI_v4.observation import GlobalObservation
# from agent.tink_AI_v2.decision_making import DemoDecision
from agent.tink_AI_v4.decision_making import DemoDecision
...
class DemoAgent(Agent):
    ...
    def __init__(self, name, config):
        ...
        self.commond_decision = DemoDecision(name, config)
        self._init()
    ...
    def step(self, sim_time, obs, **kwargs) -> List[dict]:
        ...
        cmd_list = self.commond_decision.step(sim_time, obs, **kwargs)
        return cmd_list